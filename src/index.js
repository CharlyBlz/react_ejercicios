...
const Content = (parts)=>{
  return(
    <div>
      <Part part1 = {parts.parts[0].name} excercises1={parts.parts[0].exercises}/>
      <Part part2 = {parts.parts[1].name} excercises2={parts.parts[1].exercises}/>
      <Part part3 = {parts.parts[2].name} excercises3={parts.parts[2].exercises}/>
    </div>
  )
}
const Total = (parts)=>{
